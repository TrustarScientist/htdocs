...
/**
 *  code to fetch public posts and render them
 * the code will fetch posts immediately the page loads completely
 */
...
$(document).ready(function() {
     ...
     */
    $(".more-posts-btns .next").click(function(e) {
...
function postAggregator(url, dataset = "", nextPostBtn = "", prevPostBtn = "") {
    $.post(
        url,
        dataset,
        function(data, status) {
            ...
            if (data != []) {
                ...
                responseData.forEach(postObject => {
                    ...
                    nextPostBtn.dataset.next = (Number(nextPostBtn.dataset.next) + 1);
