...
// // to fetch post data to update
// document.querySelector("#editor-data-set-btn").addEventListener("click", function(e2) {
//     $.post("/post/editor/post2edit", {}, function(data, status) {
//         alert(data);
//         let responseData = JSON.parse(data);
//         editor.setData(responseData.content);
//     });
// })
